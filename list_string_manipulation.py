...
#make a ask delte name and delete name
    ...
    if continue_list == 'yes' or continue_list == 'Yes' or continue_list == 'Y' or continue_list == 'y':
        continue
    elif continue_list == 'no' or continue_list == 'No' or continue_list == 'N' or continue_list == 'n':
